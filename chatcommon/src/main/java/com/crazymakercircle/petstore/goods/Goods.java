...
public class Goods implements IGoods{
    ...
    private static class GoodsPet extends Goods {
        private static AtomicInteger PetNo = new AtomicInteger(0);  //编号

        public GoodsPet() {
            super();
            this.goodType = Type.CLOTHES;
            this.goodName = "宠物-" + PetNo.incrementAndGet();
    ...
    private static class GoodsClothes extends Goods {
        private static AtomicInteger clothesNo = new AtomicInteger(0);  //编号

        public GoodsClothes() {
            super();
            this.goodType = Type.CLOTHES;
            this.goodName = "宠物衣服-" +clothesNo.incrementAndGet();
    ...
    private static class GoodsFood extends Goods {
        private static AtomicInteger foodNo = new AtomicInteger(0);  //编号

        public GoodsFood() {
            super();
            this.goodType = Type.FOOD;
            this.goodName = "宠物粮食-" + foodNo.incrementAndGet();
            price = RandomUtil.randInRange(50, 100);
            amount=RandomUtil.randInMod(5);
        }
    }
